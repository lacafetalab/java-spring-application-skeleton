...
public class LclException extends RuntimeException {
	...
	public LclException(int statusCode, int code, String message, Object data, Throwable t) {
		super(t);
	...
	public LclException(int statusCode, String message, Object data, Throwable t) {
		super(t);
		this.statusCode = statusCode;
